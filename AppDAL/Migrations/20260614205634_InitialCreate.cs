        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullNameOnCertificate = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaAccreditations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaAccreditations_Users_CheckedByUserId",
                        column: x => x.CheckedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MediaAccreditations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaCards_MediaAccreditations_AccreditationId",
                        column: x => x.AccreditationId,
                        principalTable: "MediaAccreditations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaAccreditations_CheckedByUserId",
                table: "MediaAccreditations",
                column: "CheckedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaAccreditations_UserId",
                table: "MediaAccreditations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaCards_AccreditationId",
                table: "MediaCards",
                column: "AccreditationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MediaCards_CardNumber",
                table: "MediaCards",
                column: "CardNumber",
                unique: true);
